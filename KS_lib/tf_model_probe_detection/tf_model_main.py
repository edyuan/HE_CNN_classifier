...
from KS_lib.tf_model_probe_detection import tf_model_test
import numpy as np

def main(nth_fold,mode, flags, test_images_list, result_path, he_dcis_segmentation_result_path, igpu):
    ...
    if mode == 'test_model':
        ...
        tf_model_test.test(object_folder, model_path, filename_list, flags, result_path, he_dcis_segmentation_result_path, igpu)